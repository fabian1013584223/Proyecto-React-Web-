    ...
    <div className="App">
        ...
        <div className="row mb-5">
                        <div className="col-md-8 col-xl-6 text-center mx-auto">
                            <h2 style={{color: '#0d6efd'}}>Nosotros</h2>
                        </div>
                            <p>SISI es una empresa creada en el año 2010, dirigida a la tecnología, otorgando a la sociedad los mejores productos tecnológicos de calidad y con un muy buen precio en el mercado. Actualmente nos encontramos ubicados en la localidad de Chapinero en la zona comercial de la ciudad y tenemos una distribución en toda la ciudad de Bogotá.</p>
                    </div>
