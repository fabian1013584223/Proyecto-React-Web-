...
const ShowUsuarios = () => {
  ...
  const openModal = (op, usuarioid, firstName, lastName, userName, password, email, phoneNumber, roles) => {
  ...
  const validar = () => {
    ...
    enviarSolicitud(usuario, operation);
  };

  const enviarSolicitud = async (usuario, operation) => {
  ...
  const deleteUsuario = (usuarioid, userName) => {
    const MySwal = withReactContent(Swal);

    MySwal.fire({
      title: `¿Seguro desea eliminar este usuario ${userName}?`,
      icon: 'question',
                    ...
                    <tr key={usuario.id}>
                      ...
                      <td>
                        ...
                        <button
                          ...
                          onClick={() => deleteUsuario(usuario.id, usuario.userName)}
                        >
