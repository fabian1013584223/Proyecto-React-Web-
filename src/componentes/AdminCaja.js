            ...
            <section className="py-4 py-xl-5" style={{paddingTop: '20px',marginTop: '21px'}}>
                <div className="container">
                    ...
                    <div className="row d-flex justify-content-center" style={{paddingTop: '0px',marginTop: '-30px'}}>
                        <div className="col-md-6 col-xl-4"><a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '32px',paddingBottom: '10px',borderColor: 'var(--bs-white)'}} href="./productos">Productos</a>
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./ShowFacturaCliente">Factura Cliente</a>
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./ShowDetalleCliente">Detalle Cliente</a>
                        ...
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./ShowMetodoPago">Metodo de Pago</a>
