...
const ShowFacturaProveedor = () => {
  const url = 'https://localhost:7284/api/facturasProveedor';
  ...
  const openModal = (op, facturaProveedorId, fechaGeneracion) => {
    ...
    if (op === 1) {
      ...
      setFacturaProveedorId(facturaProveedorId);
  ...
  const deleteUsuario = (facturaProveedorId,fechaGeneracion) => {
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          await axios.delete(`${url}/${facturaProveedorId}`);
  ...
  <table className='table table-bordered'>
    ...
    <tbody className='table-group-divider '>
      {factura.map((factura, i) => (
        <tr key={factura.facturaProveedorId}>
          <td>{i + 1}</td>
          <td>{factura.facturaProveedorId}</td>
          <td>{factura.fechaGeneracion}</td>
          <td>
            <button
              onClick={() => openModal(2, factura.facturaProveedorId, factura.fechaGeneracion)}
            ...
            <button
              onClick={() => deleteUsuario(factura.facturaProveedorId, factura.fechaGeneracion)}
            ...
            <div className='modal-body'>
              ...
              <div className='input-group mb-3'>
                ...
                <input
                  ...
                  onChange={(e) => setFacturaProveedorId(e.target.value)}
                ></input>
              </div>
              <div className='input-group mb-3'>
                <span className='input-group-text'>
