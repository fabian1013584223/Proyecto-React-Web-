...
const ShowProveedor = () => {
  ...
  const URL = `https://localhost:7284/api/Proveedores/${idProveedor}`;
  ...
  const openModal = (op, idProveedor,nitProveedor, nombre, apellido,  correo,  contacto, direccion) => {
    setIdProveedor('');
    setNitProveedor('');
    setNombre('');
    setApellido('');
  ...
  const deleteUsuario = (idProveedor, nombre) => {
                  ...
                  {proveedor.map((proveedor, i) => (
                    <tr key={proveedor.idProveedor}>
                      ...
                      <td>
                        <button
                          onClick={() =>
                            openModal(2, proveedor.idProveedor,proveedor.nitProveedor, proveedor.nombre, proveedor.apellido, proveedor.correo, proveedor.contacto,proveedor.direccion)
                          }
                        ...
                        <button onClick={()=>deleteUsuario(proveedor.idProveedor,proveedor.nombre)} className="btn btn-danger">
