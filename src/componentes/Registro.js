...
const Registro = ({ getUsuarios }) => {
    const url = 'https://localhost:7028/api/usuarios';
    ...
    <div className="App">
        ...
        <div className="row mb-5">
                        <div className="col-md-8 col-xl-6 text-center mx-auto">
                            <h2 style={{color: '#0d6efd'}}>Registrate</h2>
                            <p>Ingresa tus datos personales y disfruta de una experiencia mas agradable.&nbsp;</p>
                        </div>
                    </div>
    ...
    <div className="col-md-6 col-xl-4">
      ...
      <form>
        <div className="mb-2">
                  ...
                  />
                  {firstName.trim() === '' && (
                    <span style={{ color: 'red', fontSize: '12px' }}>Por favor, ingrese su nombre.</span>)}
                </div>
                <div className="mb-2">
                  ...
                  <input
                    ...
                    />
                    {lastName.trim() === '' && (
                      <span style={{ color: 'red', fontSize: '12px' }}>Por favor, ingrese su apellido.</span>)}
                  </div>
                <div className="mb-2">
                  ...
                  <input
                    ...
                    />
                    {userName.trim() === '' && (
                      <span style={{ color: 'red', fontSize: '12px' }}>Por favor, ingrese su nombre de usuario.</span>)}
                  </div>
                <div className="mb-2">
                  ...
                  <input
                    ...
                    />
                    {password.trim() === '' && (
                      <span style={{ color: 'red', fontSize: '12px' }}>Por favor, ingrese su contraseña.</span>)}
                  </div>
                <div className="mb-2">
                  ...
                  <input
                    ...
                    />
                    {email.trim() === '' && (
                      <span style={{ color: 'red', fontSize: '12px' }}>Por favor, ingrese su correo electrónico.</span>)}
                  </div>
                <div className="mb-2">
                  ...
                  <input
                    ...
                    />
                    {phoneNumber.trim() === '' && (
                      <span style={{ color: 'red', fontSize: '12px' }}>Por favor, ingrese su numero de telefono.</span>)}
                  </div>
                  <div className="mb-2">
