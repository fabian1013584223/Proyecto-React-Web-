                    ...
                    <div className="container">
                        <div className="row mb-5">
                            <div className="col-md-8 col-xl-6 text-center mx-auto">
                                <h2>Administrador</h2>
                                <p>Seleccione el tipo de factura que desee visualizar del control de facturas de la empresa.&nbsp;</p>
                            </div>
                        </div>
                        <div className="row d-flex justify-content-center" style={{paddingTop: '0px',marginTop: '-30px'}}>
                            <div className="col-md-6 col-xl-4"><a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '32px',paddingBottom: '10px',borderColor: 'var(--bs-white)'}} href="./FacturaCliente">&nbsp;Factura Cliente</a>
                            <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./Factura">Factura Proveedor</a>
                            <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./DetalleFacturaCliente">Detalle Factura Cliente</a>
                            <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./DetalleFacturaProveedor">Detalle Factura Proveedor</a>
                        </div>
                    </div>
                </div>
            </section>
