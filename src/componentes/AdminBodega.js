                ...
                <div className="container">
                    <div className="row mb-5">
                        <div className="col-md-8 col-xl-6 text-center mx-auto">
                            <h2 style={{color: '#0d6efd'}}>Bodega</h2>
                    ...
                    <div className="row d-flex justify-content-center" style={{paddingTop: '0px',marginTop: '-30px'}}>
                        <div className="col-md-6 col-xl-4"><a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '32px',paddingBottom: '10px',borderColor: 'var(--bs-white)'}} href="./Factura">Factura Proveedor</a>
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./ShowDetalleProveedor">Detalle Proveedor</a>
                        ...
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./Categorias">Categorias</a>
                        ...
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./ShowPrecios">Precios</a>
                    </div>
                </div>
                </div>
            </section>
